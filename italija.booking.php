...
<body>
    <header>
        ...
        <div class="container-image-italy">
    <div class="container-i">
        <h3>Grand Hotel La Favorita</h3>
        <p class="paragraph12">Hotel dobrodošlice s besplatnim prošekom po dolasku i poslasticama u sobi. Pogodno smješten u blizini željezničkih i vodenih autobuskih stanica, povijesnih spomenika i živahnih kafića. Odlične opcije za doručak, ugodan večernji happy hour i pažljivo osoblje osiguravaju ugodan boravak.</p>
        <div class="rating">
        ...
        <a href="detalji_italija.php" class="button4">Detalji</a>
        <a href="bookingform.php" class="button5">Rezerviši</a>
        <img src="italy.hotel.jpg" alt="hotel1">
    </div>

    <div class="container-i2">
        <h3>Turin Palace Hotel</h3>
        <p class="paragraph12">Smješten u prestižnoj građevini iz kasnog osamnaestog vijeka, nedavno renovirani hotel Turin Palace ima svjetle sobe opremljene sa stilom za Vaš najveći komfor, osvježavajući Spa centar za Vaš wellness i poznati restoran. Čekamo te! </p>
        <div class="rating">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
        ...
        <a href="" class="button4">Detalji</a>
        <a href="bookingform.php" class="button5">Rezerviši</a>
        <img src="italy.hotel2.jpg" alt="hotel2">
    </div>

    <div class="container-i3">
        <h3>Hotel Artemide</h3>
        <p class="paragraph12">Sa idealnom lokacijom u blizini glavnih atrakcija i metro stanica, ovaj butik hotel gostima nudi miran odmor usred užurbanih ulica. Prepustite se izvanrednom doručku, otmjenom restoranu i baru na krovu, s besplatnim mini barovima i impresivnim apartmanima za medeni mjesec. </p>
        <div class="rating">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
        ...
        <a href="" class="button4">Detalji</a>
        <a href="bookingform.php" class="button5">Rezerviši</a>
        <p class="paragraph13"> </p>
        <img src="italy.hotel3.jpg" alt="hotel3">
    </div>
</div>
