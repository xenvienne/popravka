    ...
    <header>
        ...
        <div class="container-image-italy">
            <div class="container-i">
                <h3>Pierdrei Hotel Hafencity Hamburg</h3>
                <p class="paragraph12">Ogromna zgrada ima 212 inspirativnih soba za nove posetioce i one koji već poznaju Hamburg, a izdvaja se od svih ostalih hotela na planeti od prvog pogleda.</p>
                <div class="rating">
            ...
            <i class="fas fa-star-half-alt"></i>
                ...
                <img src="njem.hotel.jpg" alt="hotel1">
                
            </div>
             <div class="container-i2">
                <h3>Steigenberger Hotel Am Kanzleramt</h3>
                <p class="paragraph12">Federalna kancelarka, zgrada Rajhstaga i glavna stanica udaljene su samo nekoliko minuta od hotela Steigenberger Am Kanzleramt - nemoguće je pronaći centralniji i pogodniji smeštaj u Berlinu. </p>
                <div class="rating">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            ...
            <i class="fas fa-star-half-alt"></i>
                ...
                <a href="" class="button4">Detalji</a>
                <a href="" class="button5">Rezerviši</a>
                <img src="njem.hotel2.jpg" alt="hotel2">
             </div>
            <div class="container-i3">
                <h3>Hotel St. Annen</h3>
                <p class="paragraph12"> Hotel Modern, smešten u prilično tihoj stambenoj četvrti u srcu Hamburga. Veoma dobrodošlo, lično i prijateljsko mesto. 32 Nepušačke sobe, kategorije su "Koliba", "Pametno-osnovno", "Bašta" i "Porodica".  </p>
                <div class="rating">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            ...
            <i class="fas fa-star-half-alt"></i>
                ...
                <img src="njem.hotel3.jpg" alt="hotel2">
            </div>
        </div>
