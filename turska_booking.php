    ...
    <header>
        ...
        <div class="container-image-italy">
            <div class="container-i">
                <h3>Divan Cave Hotel</h3>
                <p class="paragraph12">Šarmantan hotel sa izuzetnim turskim gostoprimstvom. Krovna terasa ima zadivljujući pogled na balon sa toplim vazduhom, idealan za zalaske sunca. Stručna pomoć za različite turističke rezervacije. Divan turski doručak i živopisno okruženje doline.</p>
                <div class="rating">
            ...
            <i class="fas fa-star-half-alt"></i>
                ...
                <a href="" class="button5">Rezerviši</a>
                <img src="turska.hotel.jpg" alt="hotel1">
                
            </div>
             <div class="container-i2">
                <h3>Concorde De Luxe Resort</h3>
                <p class="paragraph12">Živahni hotel koji nudi noćnu zabavu za sve uzraste, raznovrsne ugostiteljske objekte, uključujući rotirajući švedski sto i 6 à-la-carte restorana. Pohvale za prijateljske gostujuće odnose i animatorske timove. Na raspolaganju vam je više barova, uključujući opcije pored plaže i lobija. Preporučeno u Turskoj.</p>
                <div class="rating">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            ...
            <i class="fas fa-star-half-alt"></i>
                ...
                <a href="" class="button4">Detalji</a>
                <a href="" class="button5">Rezerviši</a>
                <img src="turska.hotel2.jpg" alt="hotel2">
             </div>
            <div class="container-i3">
                <h3>Kayakapi Premium Caves - Cappadocia</h3>
                <p class="paragraph12">Jedinstveni pećinski hotel sa luksuznim sobama urezanim u planinske predjele. Moderni sadržaji, lični hamam, zadivljujući pogled. Iskustvo turskog kupatila, privatni bazeni. Asistirano rezervisanje balona za vruć vazduh. </p>
                <div class="rating">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            ...
            <i class="fas fa-star-half-alt"></i>
                ...
                <img src="turska.hotel3.jpg" alt="hotel2">
            </div>
        </div>
